                                ...
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="mb-0 fs-lg fw-semibold">Notifications
                                            <span class="badge bg-danger-subtle text-danger fs-sm notification-badge">4</span>
                                        </h6>
                                        <p class="fs-md text-muted mt-1 mb-0">You have
                                            <span class="fw-semibold notification-unread">3</span> unread messages
                                        </p>
                                    </div>
                                    <div class="col-auto dropdown">
                                        <a href="javascript:void(0);" data-bs-toggle="dropdown" class="link-secondary fs-md">
                                ...
                                <div class="text-reset notification-item d-block dropdown-item position-relative">
                                    <div class="d-flex">
                                        ...
                                        <div class="position-relative me-3 flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/32/avatar-8.jpg') }}" class="rounded-circle avatar-xs" alt="user-pic">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <i class="bx bxs-user-circle" style="font-size: 34px;"></i>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('index') }}">
                            <i class="mdi mdi-lock-reset text-muted fs-lg align-middle me-1"></i>
